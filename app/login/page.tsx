    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" prefetch={false} className="inline-flex items-center space-x-2">
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to your SignAware account</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/signup" prefetch={false} className="text-blue-600 hover:underline font-medium">
                Sign up
              </Link>
            </div>
          </CardContent>
